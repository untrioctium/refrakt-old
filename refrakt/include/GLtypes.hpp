...
namespace refrakt {
	...
	USING_WITH_STATIC_ASSERT(float_t, glm::vec1, 4)
		...
		USING_WITH_STATIC_ASSERT(mat2, glm::mat2, 16)
		...
		USING_WITH_STATIC_ASSERT(mat3, glm::mat3, 36)
		...
		USING_WITH_STATIC_ASSERT(mat4, glm::mat4, 64)

		USING_WITH_STATIC_ASSERT(dmat2, glm::dmat2, 32)
		...
		USING_WITH_STATIC_ASSERT(dmat3, glm::dmat3, 72)
		...
		USING_WITH_STATIC_ASSERT(dmat4, glm::dmat4, 128)
...
#define ADD_TO_ARG_T_VARIANT(name) name, name##_array
		...
		ADD_TO_ARG_T_VARIANT(mat2), ADD_TO_ARG_T_VARIANT(mat2x3), ADD_TO_ARG_T_VARIANT(mat2x4),
		ADD_TO_ARG_T_VARIANT(mat3x2), ADD_TO_ARG_T_VARIANT(mat3), ADD_TO_ARG_T_VARIANT(mat3x4),
		ADD_TO_ARG_T_VARIANT(mat4x2), ADD_TO_ARG_T_VARIANT(mat4x3), ADD_TO_ARG_T_VARIANT(mat4),
		ADD_TO_ARG_T_VARIANT(dmat2), ADD_TO_ARG_T_VARIANT(dmat2x3), ADD_TO_ARG_T_VARIANT(dmat2x4),
		ADD_TO_ARG_T_VARIANT(dmat3x2), ADD_TO_ARG_T_VARIANT(dmat3), ADD_TO_ARG_T_VARIANT(dmat3x4),
		ADD_TO_ARG_T_VARIANT(dmat4x2), ADD_TO_ARG_T_VARIANT(dmat4x3), ADD_TO_ARG_T_VARIANT(dmat4),
		ADD_TO_ARG_T_VARIANT(texture)
		>;

	auto type_string(const texture& arg) -> const std::string;
	auto type_string(const texture_array& arg) -> const std::string;
